...
---
---
---[查看文档](http://www.lua.org/manual/5.4/manual.html#pdf-debug)
---
---@class debuglib
debug = {}
...
---
---[查看文档](http://www.lua.org/manual/5.4/manual.html#pdf-debug.debug)
---
...
---返回对象 `o` 的环境。
---
---[查看文档](http://www.lua.org/manual/5.4/manual.html#pdf-debug.getfenv)
---
---@param o any
---@return table
...
---
---[查看文档](http://www.lua.org/manual/5.4/manual.html#pdf-debug.gethook)
---
---@param co? thread
...
---返回关于一个函数信息的表。
---
---[查看文档](http://www.lua.org/manual/5.4/manual.html#pdf-debug.getinfo)
---
...
---返回给定 `value` 的元表。
---
---[查看文档](http://www.lua.org/manual/5.4/manual.html#pdf-debug.getmetatable)
---
---@param object any
...
---
---[查看文档](http://www.lua.org/manual/5.4/manual.html#pdf-debug.getuservalue)
---
---@param u userdata
---@param n integer
---@return any
...
---
---
---[查看文档](http://www.lua.org/manual/5.4/manual.html#pdf-debug.setcstacklimit)
---
---@deprecated
---@param limit integer
...
---
---[查看文档](http://www.lua.org/manual/5.4/manual.html#pdf-debug.setfenv)
---
---@version 5.1
---@generic T
---@param object T
...
---将一个函数作为钩子函数设入。
---
---[查看文档](http://www.lua.org/manual/5.4/manual.html#pdf-debug.sethook)
---
...
---
---[查看文档](http://www.lua.org/manual/5.4/manual.html#pdf-debug.setlocal)
---
...
---
---[查看文档](http://www.lua.org/manual/5.4/manual.html#pdf-debug.setmetatable)
---
---@generic T
---@param value T
---@param meta  table
...
---
---[查看文档](http://www.lua.org/manual/5.4/manual.html#pdf-debug.setuservalue)
---
...
---
---[查看文档](http://www.lua.org/manual/5.4/manual.html#pdf-debug.traceback)
---
---@param thread   thread
---@param message? any
---@param level?   integer
